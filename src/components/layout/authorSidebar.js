...
export const Sidebar = ({ author, titulo = "", edit = false }) => (
    <aside className="w-full lg:w-1/5">
        ...
        <div id="authorBox" className="p-4 border-b border-grisClaro">
            ...
            <h3 className="font-bold text-xl text-center py-3">
                {author.name}
            </h3>
            <ul className="text-center">
                {author.socialmedias &&
                    author.socialmedias.map((link) => (
            ...
            {edit && (
                <Link
                    ...
                    className="flex rounded-md my-3 px-4 py-4 font-medium leading-normal bg-rojo text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg hover:bg-white hover:text-rojo"
                >
                    Editar perfil de autor
                </Link>
            )}
        </div>
    </aside>
